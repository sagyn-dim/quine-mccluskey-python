It is a python implementaion of Quine-McCluskey algorithm which takes as input the number of literals and the minterms and then produces the reduced/optimized sum of product equation, as well as well showing the essential implicants. 
